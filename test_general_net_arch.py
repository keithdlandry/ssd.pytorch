...
parser.add_argument('--id_file', default='/home/ec2-user/computer_vision/bball_detection/'
                                         'ssd.pytorch/data/bhjc20180123_bball/bhjc_testonly.txt')
parser.add_argument('--ball_only', default=True, type=str2bool)
parser.add_argument('--square_boxes', default=True, type=str2bool)
parser.add_argument('--anno_dir', default='/home/ec2-user/computer_vision/bball_detection/'
                                          'ssd.pytorch/data/bhjc20180123_bball/annotations/')
parser.add_argument('--img_dir', default='/home/ec2-user/computer_vision/bball_detection/'
...
if __name__ == '__main__':
    ...
    if args.lookahead:
        if network_name == 'trunc':
            raise NotImplementedError('trunctated lookahead not implemented')
        net = build_lookahead_ssd('test', configs, network_name, num_classes,
