...
parser.add_argument(
    '--send_images_to_visdom', type=str2bool, default=False,
...
# parser.add_argument(
#     '--id_file',
#     default='/home/ec2-user/computer_vision/bball_detection/'
#             'ssd.pytorch/data/bhjc20180123_bball/bhjc_trainonly.txt')
...
def train():
    ...
    for iteration in range(args.start_iter, max_iter):
        ...
        if iteration % 1000 == 0:
            ...
            torch.save(ssd_net.state_dict(), 'weights/lookahead_ssd1166_{}_iter'.format(network_name) +
                       repr(iteration) + '.pth')
    ...
    torch.save(
        ssd_net.state_dict(),
        args.save_folder + 'lookahead_ssd1166_{}_final_'.format(network_name) + args.version +
        unique_id + '.pth')
